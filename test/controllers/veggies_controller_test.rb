...
class VeggiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create veggy" do
    assert_difference('Veggie.count') do
      post veggies_url, params: { veggy: { description: @veggy.description, name: @veggy.name } }
    end
  ...
  test "should update veggy" do
    patch veggy_url(@veggy), params: { veggy: { description: @veggy.description, name: @veggy.name } }
